...
;(function(win, doc) {
    ...
    var DEBUG                   = false, // switch the debug info on/off
        DEFAULT_ITEMS_PER_PAGE  = 4,
        PaginationHelper        = function(collection, itemsPerPage) {
            if (this instanceof PaginationHelper) {
                ...
                this.items_per_page = +itemsPerPage || DEFAULT_ITEMS_PER_PAGE;
                ...
                DEBUG && win.console && console.log('an instance of PaginationHelper created OK');
    ...
    function runTests() {
        if(!win.console) return; // TODO: special test environment for mobiles etc

        var val, passed;

        console.log('"usual" test cases (56 total):\n\n');

        var ph_1 = new PaginationHelper(['a','b','c','d','e','f'], 4);
        var ph_2 = new PaginationHelper(['1','2','3'], '4');
        var ph_3 = new PaginationHelper([0, 'a','b','c'], 4);
        var ph_4 = new PaginationHelper(['a',[],{},[1,2,3,null,null], null, 'e', undefined, 'f', 100500, 'ХОБАНА!', 12, {bug:'sure'}, function(){return 'BIG BUG?';}], 3);
        ...
        //
        //var ph = new PaginationHelper([1,2,3], Number.NEGATIVE_INFINITY);
        //var ph = new PaginationHelper([1,2,3], 'haha');
        //var ph = new PaginationHelper([Number.POSITIVE_INFINITY, "hahha", 9007199254740992], '4');
        //var ph = new PaginationHelper([0,null,undefined], 1.2);
        // etc etc etc...
        //

    }

    doc.getElementById("btn_test").addEventListener('click', function(e) {
        runTests();
    },false);
